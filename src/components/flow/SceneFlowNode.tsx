...
function SceneFlowNodeImpl({ id }: NodeProps) {
  ...
  const autoColor = getAutoSceneColor(scene.id, Math.max(index, 0));
  ...
  return (
    <div
      style={{ width: CANVAS_CARD_W, borderColor: isActive ? accent : accentBorder }}
        ...
        <div className="flex gap-2.5 p-2.5">
          <div className="relative shrink-0">
            ...
            <span
              ...
              className="absolute -left-1.5 -top-1.5 grid h-5 w-5 place-items-center rounded-full text-[10px] font-semibold tabular-nums text-white ring-2 ring-white"
            >
            ...
            <div className="flex items-center gap-1.5">
              ...
              {editing ? (
                <input
                  ...
                  className="nodrag nopan min-w-0 flex-1 rounded border border-[var(--color-border-strong)] bg-white px-1.5 py-0.5 text-[13px] font-semibold leading-tight text-[var(--color-ink)] outline-none focus:border-[var(--ff-violet)]"
                />
              ) : (
                <>
                  <h3
                  ...
                  <button
                    ...
                    className={cn(
                      "nodrag nopan grid h-5 w-5 shrink-0 place-items-center rounded text-[10px] font-semibold text-[var(--color-ink-faint)] transition-opacity hover:bg-[var(--color-surface-2)] hover:text-[var(--color-ink)]",
          ...
          <button
            ...
            className="nodrag nopan h-6 w-6 shrink-0 place-items-center rounded-md text-[var(--color-ink-faint)] opacity-0 transition-opacity hover:bg-[var(--color-surface-2)] hover:text-[var(--color-ink)] group-hover/node:opacity-100 [display:grid]"
          >
            <Pencil size={13} />
          </button>
        </div>
