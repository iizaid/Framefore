...
const BUTTON_CLASS =
  "inline-flex items-center justify-center gap-1 rounded-[var(--radius-button)] border border-[var(--color-border)] bg-white px-3 py-2 text-sm font-medium text-[var(--ff-charcoal)] hover:bg-[var(--color-surface-2)] disabled:cursor-not-allowed disabled:opacity-50";
...
export function AdminUsersPagination({ page, disabled = false, onOffsetChange }: AdminUsersPaginationProps) {
  ...
  return (
    <div className="flex flex-col gap-3 border-t border-[var(--color-border)] bg-white px-3 py-3 sm:flex-row sm:items-center sm:justify-between">
