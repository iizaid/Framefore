...
const SELECT_CLASS =
  "rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2 text-sm text-[var(--color-ink)] disabled:cursor-not-allowed disabled:opacity-60";
...
export function AdminUsersToolbar({
  ...
  return (
    <div className="rounded-[var(--radius-card)] border border-[var(--color-border-strong)] bg-[var(--color-surface)] p-3 sm:p-4">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div className="min-w-0 flex-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] py-2 pl-9 pr-3 text-sm text-[var(--color-ink)] placeholder:text-[var(--color-ink-soft)] disabled:cursor-not-allowed disabled:opacity-60"
            />
          </div>
          {tooLong && (
            <p className="mt-1.5 text-xs text-[var(--color-danger,#b42318)]">
        ...
        <div className="flex flex-wrap items-end gap-3">
          <div className="flex flex-col gap-1">
            <label htmlFor="admin-users-role" className="text-xs font-medium text-[var(--color-ink-soft)]">
              Role
            </label>
            <select
              id="admin-users-role"
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-[var(--color-border)] px-3 py-2 text-sm font-medium text-[var(--color-ink)] hover:bg-[var(--color-stone-surface)] disabled:cursor-not-allowed disabled:opacity-50"
          >
            <RotateCcw size={14} />
            Reset
          </button>
